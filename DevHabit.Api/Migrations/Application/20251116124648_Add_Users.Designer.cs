...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20251116124648_Add_Users")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Modules.HabitTags.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Modules.Habits.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Modules.Tags.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Api.Modules.Users.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Api.Modules.HabitTags.HabitTag", b =>
                {
                    b.HasOne("DevHabit.Api.Modules.Habits.Habit", null)
                        .WithMany("HabitTags")
                    ...
                    b.HasOne("DevHabit.Api.Modules.Tags.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DevHabit.Api.Modules.Habits.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Api.Modules.Habits.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Api.Modules.Habits.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Api.Modules.Habits.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
